---
id: chapter-05-field-notes-replay-the-optimization-story
slug: field-notes-replay-the-optimization-story
title: Field Notes · Replay the Optimization Story
summary: The Orientation RAG lab includes the same presets we evaluate in CI. Jump
  between Baseline , Latency Spike , and Budget Shift to see how TVO trades objectives
  while DVL enforces guardrails.
